        ...
        <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 box_1">
          <q-card class="no-shadow q-pa-sm">
            <q-item class="q-pb-none q-pt-xs">
              <q-item-section>
                <q-item-label class="text-h4" style="font-weight: 500;letter-spacing: 3px;">{{projects.length}}</q-item-label>
                <q-item-label :class="!$q.dark.isActive? 'text-grey-7':'text-white'" style="letter-spacing: 1px;">Total projects
                </q-item-label>
              </q-item-section>

              <q-item-section side>
                <q-icon name="folder" class="box_1" size="60px"></q-icon>
              </q-item-section>
            </q-item>
            <q-item class="q-py-xs" style="min-height: unset">
              <q-item-section>
                <div class="progress-base q-my-sm">
                  <div class="progress-bar-1" :style="{width: projects.length/developers.length * 100 + 'px'}"></div>
                </div>
              </q-item-section>
            </q-item>
          </q-card>
      ...
      <div class="row q-col-gutter-md">
        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
          <q-card flat bordered class="shadow q-pa-none q-ma-none">
            <q-card-section class="row">
              <div :class="!$q.dark.isActive? 'text-grey-7':'text-white'" class="text-h6 col-12">Income vs Expense
            ...
            <q-card-section>
              <v-chart :option="areaChartOption" ref="sales_goals" :resizable="true" style="height:320px"/>
            </q-card-section>
          </q-card>
        </div>
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
          <q-card flat bordered class="shadow q-pa-none q-ma-none">
            ...
            <q-card-section>
              <v-chart ref="market_share" :option="getBarChartOptions" :resizable="true" style="height:320px"/>
            </q-card-section>
          </q-card>
        </div>
      </div>
      <div class="row q-col-gutter-md q-pt-md">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <q-card flat bordered class="shadow q-pa-none q-ma-none">
            ...
            <q-card-section>
              <v-chart ref="key_competitors" :option="pieOptions" :resizable="true" style="height:270px"/>
            </q-card-section>
          </q-card>
        </div>
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
          <q-card flat bordered class="shadow q-pa-none q-ma-none">
            ...
            <q-card-section>
              <v-chart ref="sales_pipeline" :option="stackedBarOptions" :resizable="true" style="height:270px"/>
            </q-card-section>
          </q-card>
        </div>
      </div>
